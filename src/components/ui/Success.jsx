...
function Success({ user, logout }) {
  return (
    ...
    >
      {/* Background */}
      <div className=" absolute  bottom-0 w-full h-[50%] rounded-t-[24px] flex flex-col items-center  bg-[#FFFFFF] p-6">
        ...
        {/* Success ilustretor */}
        <motion.div
          whileHover={{ scale: 1.1, rotate: 183 }}
        ...
        >
          <div className=" rotate-180 p-4 animate-pulse ">
            <svg
              width="207"
              height="168"
              viewBox="0 0 207 168"
            ...
            >
              ...
              />
              <path
                d="M28.8425 78.5306C28.8425 78.5306 27.1961 85.177 19.3985 85.4631C14.2001 85.6539 12.9772 80.2666 6.90458 83.9134C4.20019 85.5374 2.18909 90.4719 2.18909 90.4719"
                stroke="#FB46FF"
                strokeWidth="3"
                strokeLinecap="round"
              />
              <path
                d="M31.6891 117L34.5773 124.612L42.1891 127.5L34.5773 130.388L31.6891 138L28.8009 130.388L21.1891 127.5L28.8009 124.612L31.6891 117Z"
                fill="#FE8C00"
              />
              ...
              />
              <path
                d="M185.189 133.81C190.153 133.106 200.977 134.293 204.559 144.676"
                stroke="#B468FF"
                strokeWidth="3"
                strokeLinecap="round"
              />
        ...
        <div className=" mt-4 w-full flex flex-col gap-4 justify-center">
          ...
          <button onClick={logout} className=" font-semibold p-4">
            Logout
          </button>
        </div>
      </div>
